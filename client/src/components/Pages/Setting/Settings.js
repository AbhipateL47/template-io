        ...
        <div className="col-12">
          <div className="card">
            <div className="card-body">
              ...
              <Link to={"https://cloud.mongodb.com/v2/67f245df1e46361e00c7b9e1#/metrics/replicaSet/67f24641535e5b24453f8e88/explorer/template"} target="_blank" className='btn btn-primary ms-2'>Open Database</Link>
            </div>
          </div>
        </div>
